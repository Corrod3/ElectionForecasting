...
Can non-representative polls fix this? Since the famously failure of Literature Digest poll in 1936 U.S. presidential election, pollsters have been sceptical of non-representative polling [@Squire.1988, @Goel.2017]. This scepticism is still shared among many pollsters. @Yeager.2011, for example, argue that phone surveys are still more accurate then online polls. However, they only employ simple correction approaches.

@Wang.2015 in contrast are much more optimist about the possiblities of non-representative polling. They used polling results from XBox users which were highly unrepresentative of the population to forecast the 2012 U.S. presidential elections. By employing a sophisticated multi-stage approach to stratify and calibrate the data they were able to generate accurate forecasts of the elections. More relevant from a practicioneers point of view, @Goel.2017 were able to recalibrate non-representative surveys conducted on [Amazon Mechanical Turk](https://www.mturk.com/mturk/welcome) and on a mobile phone app with less sophisticated methods achieving a level of accuracy sufficient for most applications. Hence, methods for stratifying and calibrating the forecasts are the key to meaningful forecasts based on non-representative polling. 
