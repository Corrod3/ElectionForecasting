...
The major issue at stake for pollsters in using online surveys is not genuinely different from traditional obstacles to polling. The task is to draw a sample of observations that is representative for the population of actual voters with regards to demographic and other criteria. The major difference is that respondents are anonymous and, depending on the website/source where the data is collected, potentially significantly skewed towards a certain political preference.

Akku leer deswegen jetzt Stichpunkte.
...
Using non-representative polls requires a two 
