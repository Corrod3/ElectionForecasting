...
As with all surveys, the methodology of Dalia Research has several sources of potential biases [@Groves.2009]. In the case of the Europulse survey they are primarily from flawed measurement and representation of the surveyed population (see figure \ref{fig:error}).
