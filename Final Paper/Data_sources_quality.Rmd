...
Despite these efforts, it is questionable whether the data can be regarded as representative. Below we present a simple frequency table of the self-reported past vote in the Federal Election 2013. The second figure shows that the Dalia sample significantly diverging from the actual voting results.
