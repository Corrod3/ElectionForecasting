...
<!-- data sources --->
Here explain Dalia data, election statistics, census and wahlrecht.com data (briefly)
mainly design paper part

## Raw forecasts and data quality

<!-- raw data graphics --->
Get raw forecasts and show data summary statistics -> distribution of cluster
statistics and data mining results without weighting

1. raw data forecast. Compared to other forecastes the data under represents the CDU as well as the SPD. (Verify) -> We could take the average of the german polls as computed by Süddeutsche.de

<!-- contrast data with census and exit polls and current polls -->
put here summary stats of weighting data
...
<!-- put here other data shortcommings -->
